    ...
    <article className="bg-gruvgray/50 justify-center items-center rounded-2xl ">
      <header className="flex items-center gap-3 px-4 pt-3">
        ...
        <div className="flex items-center gap-3 flex-1">
          ...
          <span className=" flex ml-auto text-[13px] font-semibold uppercase tracking-wide">
            CS353
          </span>
        </div>
      </header>
      ...
      <footer className="px-4 flex justify-end gap-4 py-2">
        <button className="">
          <Like className="hover:scale-125 duration-300 cursor-pointer" />
          <span className="text-xs">{post.likeCount}</span>
        </button>
        <button>
          <Comment className="hover:scale-125 duration-300 cursor-pointer " />
